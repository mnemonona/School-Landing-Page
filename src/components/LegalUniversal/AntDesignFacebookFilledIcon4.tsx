...
const AntDesignFacebookFilledIcon4 = (props: SVGProps<SVGSVGElement>) => (
...
const Memo = memo(AntDesignFacebookFilledIcon4);
export { Memo as AntDesignFacebookFilledIcon4 };
