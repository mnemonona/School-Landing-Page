...
const AntDesignFacebookFilledIcon3 = (props: SVGProps<SVGSVGElement>) => (
...
const Memo = memo(AntDesignFacebookFilledIcon3);
export { Memo as AntDesignFacebookFilledIcon3 };
