...
const AntDesignFacebookFilledIcon2 = (props: SVGProps<SVGSVGElement>) => (
...
const Memo = memo(AntDesignFacebookFilledIcon2);
export { Memo as AntDesignFacebookFilledIcon2 };
