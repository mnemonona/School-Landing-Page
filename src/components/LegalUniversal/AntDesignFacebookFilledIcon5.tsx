...
const AntDesignFacebookFilledIcon5 = (props: SVGProps<SVGSVGElement>) => (
...
const Memo = memo(AntDesignFacebookFilledIcon5);
export { Memo as AntDesignFacebookFilledIcon5 };
